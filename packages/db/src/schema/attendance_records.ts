...
export const attendanceRecords = pgTable(
  ...
  (table) => ({
    ...
    sessionIdIdx: index("attendance_records_session_id_idx").on(
      table.sessionId,
    ),
    scannedAtIdx: index("attendance_records_scanned_at_idx").on(
      table.scannedAt,
    ),
    eventScannedAtIdx: index("attendance_records_event_id_scanned_at_idx").on(
      table.eventId,
      table.scannedAt,
    ),
